  ...
  return (
    <div className="d-flex mt-3 mb-2 px-3 position-relative d-flex justify-content-between align-items-center">
      <div className="bg-reactions like-display">
        <span>
          <svg
            ...
            fill="currentColor"
            className="mercado-match reactions"
            width="24"
            height="24"
            focusable="false"
          >
        ...
        <ReactionsHover renderAgain={renderAgain} postId={postId} />
      </div>
      <div
        className="bg-reactions"
        onClick={() =>
      ...
      >
        ...
        <span className="ml-1 reactions-titles">Comment</span>
      </div>
      <div className="bg-reactions">
        ...
        <span className="ml-1 reactions-titles">Share</span>
      </div>
      <div className="bg-reactions">
        <span>
          <svg
        ...
        <span className="ml-1 reactions-titles">Send</span>
      </div>
    </div>
  );
};
