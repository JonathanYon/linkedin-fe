  ...
  const addExperienceImage = async (expID) => {
    try {
      let response = await fetch(
        ...
        }profile/experience/${window.localStorage.getItem(
          "_id"
        )}/update/${expID}/image`,
        {
          method: "PUT",
  ...
  return (
    ...
    >
        ...
        <Form>
          <div className="network">
            <div className="one mb-3">
              ...
              <span className="make-it-gray">
                If enabled, your network may be informed of job changes,
                education changes, and work anniversaries. It may take up to 2
                hours to share your job changes with your network.
              </span>
              <span className="make-it-blue">
                {" "}
                Learn how these are shared and when
              </span>
            </div>
          ...
          <div className="split">
            <div className="first-section">
              <Form.Group controlId="role">
                <Form.Label className={error ? "text-danger fw-bold" : ""}>
                ...
                <Form.Control
                  ...
                  placeholder={
                    endpoint === "POST" ? "Enter propsrole" : formData.role
                  }
            ...
            <div className="first-section">
              <Form.Group controlId="area">
                <Form.Label className={error ? "text-danger fw-bold" : ""}>
                  Location (city,country) {error ? "Required" : ""}
                </Form.Label>
                <Form.Control
                  type="text"
                  placeholder={
                    endpoint === "POST" ? "propsendare" : formData.area
                  }
          ...
          <Form.Row className="dateInputs">
            <Form.Group as={Col} controlId="startDate">
              <Form.Label className={error ? "text-danger fw-bold" : ""}>
                Start Date {error ? "Required" : ""}
              </Form.Label>
              <Form.Control
                type="date"
                value={endpoint === "POST" ? "" : formData.startDate}
                onChange={(e) =>
                  handleForm(
                    "startDate",
            ...
            <Form.Group as={Col} controlId="endDate">
              <Form.Label className={error ? "text-danger fw-bold" : ""}>
                End Date {error ? "Required" : ""}
              </Form.Label>
              <Form.Control
                type="date"
                value={endpoint === "POST" ? "" : formData.endDate}
                onChange={(e) =>
                  handleForm(
                    "endDate",
                    format(new Date(e.target.value), "yyyy-MM-dd")
        ...
        <div className="second-section">
          ...
          <Form.Group as={Col} controlId="description">
            ...
            <Form.Control
              ...
              rows={5}
              placeholder={
                endpoint === "POST" ? "addDescription" : formData.description
              }
          ...
          <Form>
            <div className="Media fix">
              ...
              <p className="make-it-gray font-small">
            ...
            <Form.Group className="d-flex flex-nowrap">
              <div className="btn btn-blue d-flex justify-content-center align-items-center w-50 position-relative border-2-4rem pr-2">
                ...
                <Form.File
                  ...
                  className="upload-Exp-img position-absolute w-100 h-100"
                  onChange={(e) => {
              ...
              <div className="btn btn-outline-primary btn-outline-uploadXPImage verticalAlign w-50 border-2-4rem pl-2">
                {" "}
                <span>Link</span>
              </div>
            </Form.Group>
      ...
      <Modal.Footer className="justify-content-between">
        {props.requestmethod === "PUT" && (
          <Button
            variant=""
            className="border-2-4rem connect_button"
        ...
        <Button
          variant=""
          className="btn-blue saveExpImg-padding-Mod border-2-4rem"
