    ...
    <>
      ...
      >
          ...
          <Form>
            <Form.Row>
              ...
              <Form.Group as={Col} controlId="surname">
                <Form.Label className={error ? "text-danger fw-bold" : ""}>
                  Last Name* {error ? "Required" : ""}
                </Form.Label>
                <Form.Control
                  type="text"
                  className="change-border"
                  defaultValue={window.localStorage.getItem("surname")}
            ...
            <div>
              <span className="make-gray">+ Record name pronunciation</span>
              <br></br>
              <span className="make-gray-2">
            ...
            <Form.Group>
              ...
              <span className="make-gray-2">
                ...
                <span className="make-blue-2">Learn more</span>
              </span>
              <br></br>
              <svg
              ...
              <span className="make-blue-2 mx-1">
            ...
            <Form.Row>
              <Form.Group as={Col} controlId="title">
                ...
                />
                <div>
                  <p className="make-blue-3">
                    <span>+</span> Add current position
                  </p>
                </div>
              </Form.Group>
            </Form.Row>
            ...
            <Form.Row>
              <Form.Group className="col-4">
                ...
                <Form.Control
                  className="change-border"
                  type="text"
                  placeholder="ex: L25 59AA"
                />
              </Form.Group>
              <Form.Group as={Col}>
                <Form.Label className={error ? "text-danger fw-bold" : ""}>
                  Locations within this area {error ? "Required" : ""}
                </Form.Label>
                <Form.Control
                  className="change-border"
                  type="text"
                  defaultValue={window.localStorage.getItem("area")}
        ...
        <Modal.Footer>
          ...
          <Button className="custom-btn" onClick={() => updateProfileInfo()}>
            Save
          </Button>
        </Modal.Footer>
      </Modal>
